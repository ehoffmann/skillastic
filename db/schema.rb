...
ActiveRecord::Schema.define(version: 20151123103048) do
  ...
  add_index "abilities", ["skill_id"], name: "index_abilities_on_skill_id", using: :btree
  add_index "abilities", ["worker_id"], name: "index_abilities_on_worker_id", using: :btree
